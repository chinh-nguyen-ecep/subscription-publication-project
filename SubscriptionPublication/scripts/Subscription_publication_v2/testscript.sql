...
INSERT INTO CONTROL.spctl_pub_customer_article (
	subscription_key
	,df_config_id
	)
VALUES (
...
INSERT INTO CONTROL.spctl_pub_customer (
	customer_name
	,customer_desc
	,folder_content_transfer_script
	,transfer_script_name
	)
VALUES (
	'Daily Verve Ads Group'
	,'Group users will receive Daily Verve Ads report by email'
	,'/home/postgres/bin/subscription_publication'
	,'publicToEmail.pl'
	);

INSERT INTO CONTROL.spctl_customer_contact (
	customer_email
...
INSERT INTO CONTROL.spctl_subscription_publication_checkpoint (subscription_key)
VALUES (27);

UPDATE CONTROL.spctl_subscription_publication_process
SET process_status = 'WT'
WHERE publication_process_id = 3796;
...
SET df_attribute = ''
WHERE df_config_id IN (
		176
		,177
		,178
		);

UPDATE CONTROL.spctl_pub_customer_article
SET articel_status = 'INACTIVE'
WHERE customer_article_key IN (
		121
		,122
		,119
		,117
...
SELECT *
FROM CONTROL.fn_spctl_insert_subscription_to_process(26, 'date=2014-03-01', true);

SELECT *
FROM CONTROL.fn_spctl_insert_subscription_to_process(27, 'date=2014-03-02', true);
...
WHERE df_config_id = 179;

UPDATE CONTROL.spctl_pub_customer_subscription
SET subscription_desc = 'Attached is Daily Verve Ads Report V1'
WHERE subscription_key = 27;

UPDATE CONTROL.spctl_customer_contact
SET customer_contact_status = 'ACTIVE'
